...
public final class AosJarSmokeTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            if (indexCreated) {
                require(client.indices().delete(request -> request.index(index)).acknowledged(), "index deletion was not acknowledged");
                require(!client.indices().exists(request -> request.index(index)).value(), "temporary index still exists");
