...
public class OpenSearchIngestionClient extends ApiClient<OpenSearchTransport, OpenSearchIngestionClient> {
    ...
    @Override
    public OpenSearchIngestionClient withTransportOptions(@Nullable TransportOptions transportOptions) {
        return new OpenSearchIngestionClient(this.transport, transportOptions);
    }
