...
public class OpenSearchUbiClient extends ApiClient<OpenSearchTransport, OpenSearchUbiClient> {
    ...
    @Override
    public OpenSearchUbiClient withTransportOptions(@Nullable TransportOptions transportOptions) {
        return new OpenSearchUbiClient(this.transport, transportOptions);
    }
