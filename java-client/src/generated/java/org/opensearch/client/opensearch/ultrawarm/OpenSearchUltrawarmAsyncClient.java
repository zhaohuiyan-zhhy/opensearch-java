...
public class OpenSearchUltrawarmAsyncClient extends ApiClient<OpenSearchTransport, OpenSearchUltrawarmAsyncClient> {
     ...
     */
    public CompletableFuture<CancelMigrationResponse> cancelMigration(CancelMigrationRequest request, ApiType type) throws IOException,
        OpenSearchException {
     ...
     * @param type target OpenSearch API distribution
     */
    public CompletableFuture<GetMigrationStatusResponse> getMigrationStatus(GetMigrationStatusRequest request, ApiType type)
        throws IOException, OpenSearchException {
     ...
     * @param type target OpenSearch API distribution
     */
    public CompletableFuture<ListMigrationStatusResponse> listMigrationStatus(ListMigrationStatusRequest request, ApiType type)
        throws IOException, OpenSearchException {
     ...
     * @param type target OpenSearch API distribution
     */
    public final CompletableFuture<ListMigrationStatusResponse> listMigrationStatus(ApiType type) throws IOException, OpenSearchException {
     ...
     * @param type target OpenSearch API distribution
     */
    public CompletableFuture<MigrateToColdResponse> migrateToCold(MigrateToColdRequest request, ApiType type) throws IOException,
        OpenSearchException {
     ...
     * @param type target OpenSearch API distribution
     */
    public CompletableFuture<MigrateToHotResponse> migrateToHot(MigrateToHotRequest request, ApiType type) throws IOException,
        OpenSearchException {
     ...
     * @param type target OpenSearch API distribution
     */
    public CompletableFuture<MigrateToWarmResponse> migrateToWarm(MigrateToWarmRequest request, ApiType type) throws IOException,
        OpenSearchException {
